...
var LiveWallpaperSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    tableDescription.innerHTML = "Define UI elements and CSS attributes that should be made transparent. This allows the wallpaper to appear behind the interface, improving readability and aesthetic. Each row lets you specify a target element (CSS selector) and the attribute you want to override.<br><br>Example targets and attributes you can modify:<br>\u2022 attribute: <code>--background-primary</code><br>\u2022 attribute: <code>--background-secondary</code><br>\u2022 attribute: <code>--background-secondary-alt</code><br>\u2022 attribute: <code>--col-pr-background</code><br>\u2022 attribute: <code>--col-bckg-mainpanels</code><br>\u2022 attribute: <code>--col-txt-titlebars</code><br><br>You can inspect elements and variables using browser dev tools (CTRL + SHIFT + I) to discover more attributes to adjust.";
    ...
    if (import_obsidian4.Platform.isDesktop) {
      ...
      new import_obsidian4.Setting(advancedOptionsContainer).setName("Modal dim color").setDesc("Choose whether the modal background dim is black or white").addDropdown((dropdown) => {
      ...
      new import_obsidian4.Setting(advancedOptionsContainer).setName("Disable modal background").setDesc("Turns off the default modal background dim").addToggle((toggle) => {
