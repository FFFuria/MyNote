...
**平均池化：**
区域内平均值
***不管原来特征图是多少通道，卷积完生成的新特征图的通道数都等于卷积核的个数***
# LeNet-5
*5代表5层网络*
## 结构
**模型单元结构**
...
**全连接层**
	 ...
	 输出：2维 （B,FL) *f是filter*
## 计算
![[file-20251225202137641.png]]
“6”就是卷积核的“个数”，输入通道数决定卷积核通道数(深度)，卷积核的个数决定输出的通道数
为了高性能，往往会对卷积层进行排列，同时增加通道数
# AlexNet
![[file-20251226203130472.png]]
![[file-20260101195400435.png]]
## 结构
**模型单元结构**
	1. 卷积层x5
	2. ReLU函数
...
## DropOut
***防止过拟合***
防止出现图片稍微出现变化便识别不出的一种过拟合，甚至还能加速训练
**正常流程:**
...
**Dropout流程:**
	...
	3. 然后继续重复这一过程
![[file-20251226204707583.png|322]]
## 图像增强（仅作为补充）
**水平翻转、随机裁剪、PCA**
### PCA
**PCA图像增强流程:**
...
![[file-20251226212303740.png|467]]
### LRN正则化
![[file-20260101194456360.png]]
	 **k:** 防止公式出现分母为0
## 类模板操作
### class
1. 定义 *前面定义后面用 *
